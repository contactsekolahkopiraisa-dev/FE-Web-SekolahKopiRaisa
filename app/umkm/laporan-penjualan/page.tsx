// app/umkm/laporan-keuangan/page.tsx
"use client";
...
import LaporanKeuanganTableUmkm from "@/components/laporan-keuangan/LaporanKeuanganTableUmkm";
import { fetchAllLaporanKeuangan } from "@/app/utils/laporan-keuangan";
import { getUserId } from "@/app/utils/auth"; // Import helper function

export default function LaporanKeuanganUmkm() {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (
          ...
          console.log("Jumlah data sebelum filter:", dataArray.length);
        ...
        // Asumsi struktur data laporan memiliki field user_id atau partner.user_id
        const filteredData = dataArray.filter((item: any) => {
          // Cek berbagai kemungkinan struktur data
          return (
            item.user_id === currentUserId ||
            item.partner?.user_id === currentUserId ||
        ...
        console.log("Jumlah data setelah filter:", filteredData.length);
  ...
  const handleView = (id: number) => {
    window.location.href = `/umkm/laporan-keuangan/edit/${id}`;
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {/* Tombol Tambah */}
        <div>
          <Link href={"/umkm/laporan-keuangan/create"}>
