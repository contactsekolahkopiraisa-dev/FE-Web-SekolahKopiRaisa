...
function DetailPelaksanaanMagangContent() {
            ...
            <div className="md:col-span-2 rounded-xl border border-[#E8E2DB] bg-white p-4 md:p-6">
              ...
              <div className="mt-3 space-y-3">
                ...
                {(() => {
                  ...
                  if (typeof window !== "undefined") {
                    console.log(
                      "[DetailPelaksanaanMagang] render MOU, raw:",
              ...
              <div className="rounded-lg border border-[#F0EAE3] bg-[#FBF9F7] p-4">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value="Magang" // Ganti dengan "Magang" atau "Pelatihan" sesuai file
                      disabled
...
export default function DetailPelaksanaanMagangPage() {
  return (
    <Suspense fallback={<LoadingFallback />}>
      <DetailPelaksanaanMagangContent />
    </Suspense>
  );
}
