    ...
    <>
              ...
              <div className="rounded-lg bg-[#F7F4F0] border border-[#E8E2DB] p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                  <div>
                    ...
                    <p className="text-[13px] font-medium text-[#3B3B3B]">Kunjungan</p>
                  </div>
                  <div>
                    <p className="text-[11px] text-[#6B6B6B] mb-1">Jumlah Peserta</p>
                    <p className="text-[13px] font-medium text-[#3B3B3B]">1</p>
                  </div>
                  <div>
                    <p className="text-[11px] text-[#6B6B6B] mb-1">Tanggal Kunjungan</p>
                    <p className="text-[13px] font-medium text-[#3B3B3B]">01/10/2025</p>
                  </div>
                  <div>
                    <p className="text-[11px] text-[#6B6B6B] mb-1">Nama Peserta</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div className="text-center md:text-left">
                ...
                <h3 className="text-base md:text-lg font-semibold text-[#3B3B3B]">
                  Selamat, Kunjungan Anda telah selesai!
                </h3>
                <p className="mt-1 text-[12px] text-[#6B6B6B]">
      ...
      <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm">© 2025 Detail Pelaksanaan Pengajuan Kunjungan. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
