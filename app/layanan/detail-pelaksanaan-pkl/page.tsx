...
import { Check, Download, Eye, FileText, Handshake, ClipboardList, FileCheck, Award, XCircle, CheckCircle2, Upload, Info } from "lucide-react";
            ...
            <div className="rounded-xl border border-[#E8E2DB] bg-white p-4 md:p-6">
              ...
              <div className="mt-4 space-y-3">
                {steps.map((s, idx) => {
                  ...
                  const descColorClass = s.name === "Pengajuan"
                    ? pengajuanDecision === "disetujui"
                      ? "text-[#2F8A57]"
                      : pengajuanDecision === "ditolak"
                      ? "text-[#CD0300]"
                      : "text-[#6B6B6B]"
                    : stepStatuses[idx] === "disetujui" || stepStatuses[idx] === "selesai"
                    ? "text-[#2F8A57]"
      ...
      {pengajuanDecision === "disetujui" && mouDecision !== ("disetujui" as typeof mouDecision) && (
        <div className="container mx-auto px-4 max-w-6xl mb-8">
          ...
          >
            ...
            <p className="text-[12px] text-[#6B6B6B] mb-4">
              Pengajuan anda telah disetujui. Silahkan download template MOU dan upload kembali setelah ditandatangani.
            </p>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              {mouDecision === "ditolak" && (
                <div className="rounded-lg border border-[#F0CFCF] bg-[#FFF6F6] p-4 text-center">
                  ...
                  <p className="mt-1 text-[12px] text-[#6B6B6B]">
                    MoU yang Anda unggah ditolak. Pastikan format dan isi MoU telah sesuai ketentuan, serta ditandatangani pihak terkait.
                  </p>
                </div>
              )}
              ...
              <div className="rounded-lg border border-[#E8E2DB] bg-white p-4">
                ...
                >
                  ...
                  {!mouFile && (
                    <p className="text-[11px] text-[#9A948E]">Format: .pdf, .doc, .docx (Max: 10MB)</p>
                  )}
      ...
      {mouDecision === "disetujui" && pelaksanaanDecision !== ("selesai" as typeof pelaksanaanDecision) && (
        <div className="container mx-auto px-4 max-w-6xl mb-8">
          <div className={`rounded-xl border bg-white p-5 md:p-6 ${
            ...
            <p className="text-[12px] text-[#6B6B6B] mb-4">
              Akses semua materi pada modul pembelajaran pada layanan yang dipilih
            </p>
            ...
            <div className="rounded-lg border border-[#F0EAE3] bg-[#FBF9F7] p-4">
              <div className="space-y-3">
                ...
                <div className="pt-2 text-right">
                  <button onClick={handleSubmitLaporan} className="inline-flex items-center rounded-lg bg-[#5C3A1E] text-white px-4 py-2 text-[12px] hover:opacity-90">
                    Submit
                  </button>
                </div>
              </div>
          ...
          {laporanSubmitted && laporanDecision === "disetujui" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div className="text-center md:text-left">
                ...
                <h3 className="text-base md:text-lg font-semibold text-[#3B3B3B]">Selamat, Program PKL Anda telah selesai!</h3>
                <p className="mt-1 text-[12px] text-[#6B6B6B]">
